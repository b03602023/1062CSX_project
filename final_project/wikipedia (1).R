...
topic <- c_text$"主題"
topic_seg <- processdata(topic)
topic_freqFrame <- as.data.frame(table(unlist(topic_seg)))


library(wordcloud2)

windowsFonts(TC=windowsFont("Heiti TC Light"))
wordcloud(topic_freqFrame$Var1,topic_freqFrame$Freq,
          scale=c(10,1),
