...
##### Extracting TARGET  ???Ʊ?TARGET?o???ܼƨ????U?????ާ@?v?T
...
features_pair <- combn(names(train), 2, simplify = F) #?զX(2?Ӭ??@??)
toRemove <- c()
...
library(dplyr)
feature.names <- setdiff(names(train), toRemove)  #???X?S?ʤ??P???ܼ?(???S?ʬۦP???ܼƲ???)
...
### Frequentist cut
#??train data???̤j?̤p?ȧ@??probability???��?
#(????O?????D???????o?n?o?˰??A?]???o?˳s?̤j?Ȫ?preds?Ȥ]?|?p??0.5?A?̫??ܦ?target??0)
